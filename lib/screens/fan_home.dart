...
// Rename this class to FanHomeScreen for clarity
class FanHomeScreen extends StatefulWidget {
  final Map<String, dynamic>? userData;
  
  const FanHomeScreen({Key? key, this.userData}) : super(key: key);
...
class _FanHomeScreenState extends State<FanHomeScreen> {
  ...
  void initState() {
    super.initState();
    _screens = [
      UserHomeContent(userData: widget.userData),
      SearchScreen(),
          ...
          DrawerHeader(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                Text(
                  widget.userData?['name'] ?? 'Sports Fan',
                  style: TextStyle(
                ...
                Text(
                  widget.userData?['interests'] ?? 'Sports Enthusiast',
                  style: TextStyle(
...
// Update UserHomeContent to accept userData
class UserHomeContent extends StatelessWidget {
  final Map<String, dynamic>? userData;
  
  const UserHomeContent({Key? key, this.userData}) : super(key: key);
